                ...
                >
                        ...
                        >
                                ...
                                <p className="mb-8 text-base leading-relaxed text-gray-600 md:text-lg">
                                        Inmobiliaria Villanueva García es sinónimo de excelencia y confianza. Nuestra
                                        misión es brindarte una experiencia única al encontrar tu próximo hogar o
                                        inversión. Fusionamos elegancia, modernidad y total transparencia en cada paso
                                        del proceso, para que te sientas acompañado desde el primer vistazo hasta la
                                        firma final.
                                </p>
                                <motion.a
                                        href="#contacto"
                                                                ...
                                                                {activeReview ? (
                                                                        ...
                                                                        >
                                                                                <div className="flex flex-wrap items-center gap-2 text-base font-semibold text-[var(--text-dark)]">
                                                                                        ...
                                                                                        <span>{activeReview.displayName}</span>
                                                                                        {typeof activeReview.starRating === "number" && (
                                                                                                <span className="text-sm font-medium text-gray-500">
                                                                                                        {(() => {
                                                                                                                const normalized = Math.round(activeReview.starRating);
                                                                                                                const starCount = Math.max(0, Math.min(5, normalized));
                                                                                                                return starCount > 0 ? "★".repeat(starCount) : null;
                                                                                                        })()}
                                                                                                </span>
                                                                                        )}
                                                                                </div>
                                                                        ...
                                                                        >
                                                                                Aún no tenemos reseñas disponibles, ¡pero pronto compartiremos las experiencias de nuestros clientes!
                                                                        </motion.p>
                                                                )}
                                                        </AnimatePresence>
                                                </div>
                        ...
                        >
                                <img
                                        ...
                                        className="h-64 w-full rounded-2xl object-cover shadow-xl ring-1 ring-gray-200/50 md:h-80"
                                        loading="lazy"
                                />
